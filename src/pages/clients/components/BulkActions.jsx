...
import { X, CheckCircle, UserX, Archive, Trash2, AlertTriangle } from 'lucide-react'
        ...
        switch (pendingAction) {
            case 'activate':
                return {
                    ...
                    description: `Are you sure you want to activate ${selectedCount} selected client(s)?`,
                    icon: CheckCircle,
            ...
            case 'deactivate':
                return {
                    ...
                    description: `Are you sure you want to deactivate ${selectedCount} selected client(s)?`,
                    icon: UserX,
            ...
            case 'archive':
                return {
                    ...
                    description: `Are you sure you want to archive ${selectedCount} selected client(s)? They can be restored later.`,
                    icon: Archive,
                    color: 'text-orange-400',
                    buttonText: 'Archive',
                    buttonClass: 'bg-orange-500 hover:bg-orange-600',
            ...
            case 'delete':
                return {
                    ...
                    description: `Are you sure you want to permanently delete ${selectedCount} selected client(s)? This action cannot be undone.`,
                    icon: Trash2,
                    color: 'text-red-400',
                    buttonText: 'Delete',
